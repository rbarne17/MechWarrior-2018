...
public final class RobotMap {
	...
	// limit switches
	public static final int liftLimitSwitchHome = 10;
	public static final int gripperLimitSwitchClose=8;
	public static final int gripperLimitSwitchOpen=7;
	public static final int flipityFlopLimitSwitchUp=6;
